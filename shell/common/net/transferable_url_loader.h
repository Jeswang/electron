...
// Interposes on a URLLoader request so its original response body pipe can
// either be read by JavaScript or transferred untouched to another client.
class TransferableURLLoader final : public network::SharedURLLoaderFactory,
 ...
 private:
  ...
  scoped_refptr<network::SharedURLLoaderFactory> upstream_factory_;
  GURL final_url_;
  Disposition disposition_ = Disposition::kUnclaimed;
  bool response_received_ = false;
  bool pipe_closed_ = false;
  mojo::Remote<network::mojom::URLLoader> upstream_loader_;
  mojo::Receiver<network::mojom::URLLoaderClient> upstream_client_receiver_{
      this};
  mojo::Receiver<network::mojom::URLLoader> downstream_loader_receiver_{this};
  mojo::Remote<network::mojom::URLLoaderClient> downstream_client_;
